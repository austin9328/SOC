...
rx_seen_reg: unisim.vcomponents.FDRE
     port map (
      C => clk,
      CE => '1',
      D => rx_seen_reg_0,
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_uart_rx is
  ...
  signal rx_seen_i_2_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \bit_cnt[1]_i_2\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \bit_cnt[3]_i_2\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \digit[3]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of rx_seen_i_1 : label is "soft_lutpair3";
begin
...
\prescale_reg[4]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\prescale_reg[8]_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000FFFFFFFFFFFE"
    )
        port map (
...
\prescale_reg[8]_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\prescale_reg_reg[8]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3 downto 2) => prescale_reg_reg(11 downto 10),
      DI(1) => \bit_cnt[3]_i_3_n_0\,
      DI(0) => \bit_cnt[3]_i_3_n_0\,
...
rx_seen_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"001F0000"
    )
        port map (
...
rx_seen_i_2: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFDFFFFF"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_uart_tx is
  ...
  signal \bit_cnt_reg_n_0_[2]\ : STD_LOGIC;
  signal \bit_cnt_reg_n_0_[3]\ : STD_LOGIC;
  signal data : STD_LOGIC_VECTOR ( 18 downto 4 );
...
\_inferred__0/i__carry__2\: unisim.vcomponents.CARRY4
     port map (
      ...
      O(2 downto 0) => data(18 downto 16),
      S(3) => '0',
      S(2) => p_0_in(18),
...
\prescale_reg[0]_i_3\: unisim.vcomponents.LUT6
    generic map(
...
display_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_uart_7seg_display
     port map (
      E(0) => uart_rx_inst_n_10,
      Q(3 downto 0) => rx_data(3 downto 0),
      clk => clk,
      rst => rst,
      rx_seen => rx_seen,
      rx_seen_reg_0 => uart_rx_inst_n_1,
