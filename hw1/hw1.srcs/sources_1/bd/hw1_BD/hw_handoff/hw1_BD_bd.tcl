...
################################################################
# This is a generated script based on design: hw1_BD
#
...
proc create_root_design { parentCell } {
  ...
  # Create instance: my_led_ip_0, and set properties
  set block_name my_led_ip
  set block_cell_name my_led_ip_0
  if { [catch {set my_led_ip_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $my_led_ip_0 eq "" } {
  ...
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins my_led_ip_0/led_input]
  connect_bd_net -net my_led_ip_0_led_out [get_bd_ports led] [get_bd_pins my_led_ip_0/led_out]
