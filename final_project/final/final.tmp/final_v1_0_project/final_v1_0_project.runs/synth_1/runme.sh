...
HD_PWD='c:/soc/final/final.tmp/final_v1_0_project/final_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log final_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source final_v1_0.tcl
