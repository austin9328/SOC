...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_uart_7seg_display is
  port (
    rx_seen : out STD_LOGIC;
    seg : out STD_LOGIC_VECTOR ( 6 downto 0 );
    rst : in STD_LOGIC;
    \digit_reg[0]_0\ : in STD_LOGIC;
    Q : in STD_LOGIC_VECTOR ( 3 downto 0 );
    clk : in STD_LOGIC;
    rst_n : in STD_LOGIC
  );
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_uart_7seg_display;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_uart_7seg_display is
  signal digit : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \rx_seen_cnt[0]_i_1_n_0\ : STD_LOGIC;
  signal \rx_seen_cnt[1]_i_1_n_0\ : STD_LOGIC;
  signal \rx_seen_cnt[2]_i_1_n_0\ : STD_LOGIC;
  signal \rx_seen_cnt[3]_i_1_n_0\ : STD_LOGIC;
  signal \rx_seen_cnt_reg_n_0_[0]\ : STD_LOGIC;
  signal \rx_seen_cnt_reg_n_0_[1]\ : STD_LOGIC;
  signal \rx_seen_cnt_reg_n_0_[2]\ : STD_LOGIC;
  signal \rx_seen_cnt_reg_n_0_[3]\ : STD_LOGIC;
...
\rx_seen__0\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
      I0 => \rx_seen_cnt_reg_n_0_[1]\,
      I1 => \rx_seen_cnt_reg_n_0_[0]\,
      I2 => \rx_seen_cnt_reg_n_0_[2]\,
      I3 => \rx_seen_cnt_reg_n_0_[3]\,
      O => rx_seen
    );
\rx_seen_cnt[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000055540000"
    )
        port map (
      I0 => \rx_seen_cnt_reg_n_0_[0]\,
      I1 => \rx_seen_cnt_reg_n_0_[1]\,
      I2 => \rx_seen_cnt_reg_n_0_[2]\,
      I3 => \rx_seen_cnt_reg_n_0_[3]\,
      I4 => rst_n,
      I5 => \digit_reg[0]_0\,
      O => \rx_seen_cnt[0]_i_1_n_0\
    );
\rx_seen_cnt[1]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I0 => \digit_reg[0]_0\,
      I1 => \rx_seen_cnt_reg_n_0_[1]\,
      I2 => \rx_seen_cnt_reg_n_0_[0]\,
      I3 => \rx_seen_cnt_reg_n_0_[2]\,
      I4 => \rx_seen_cnt_reg_n_0_[3]\,
      I5 => rst_n,
      O => \rx_seen_cnt[1]_i_1_n_0\
    );
\rx_seen_cnt[2]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"00000000CCC20000"
    )
        port map (
      I0 => \rx_seen_cnt_reg_n_0_[3]\,
      I1 => \rx_seen_cnt_reg_n_0_[2]\,
      I2 => \rx_seen_cnt_reg_n_0_[0]\,
      I3 => \rx_seen_cnt_reg_n_0_[1]\,
      I4 => rst_n,
      I5 => \digit_reg[0]_0\,
      O => \rx_seen_cnt[2]_i_1_n_0\
    );
\rx_seen_cnt[3]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => \rx_seen_cnt_reg_n_0_[3]\,
      I5 => rst_n,
      O => \rx_seen_cnt[3]_i_1_n_0\
    );
\rx_seen_cnt_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => clk,
      CE => '1',
      D => \rx_seen_cnt[0]_i_1_n_0\,
      Q => \rx_seen_cnt_reg_n_0_[0]\,
      R => '0'
    );
\rx_seen_cnt_reg[1]\: unisim.vcomponents.FDRE
     port map (
      C => clk,
      CE => '1',
      D => \rx_seen_cnt[1]_i_1_n_0\,
      Q => \rx_seen_cnt_reg_n_0_[1]\,
      R => '0'
    );
\rx_seen_cnt_reg[2]\: unisim.vcomponents.FDRE
     port map (
      C => clk,
      CE => '1',
      D => \rx_seen_cnt[2]_i_1_n_0\,
      Q => \rx_seen_cnt_reg_n_0_[2]\,
      R => '0'
    );
\rx_seen_cnt_reg[3]\: unisim.vcomponents.FDRE
     port map (
      C => clk,
      CE => '1',
      D => \rx_seen_cnt[3]_i_1_n_0\,
      Q => \rx_seen_cnt_reg_n_0_[3]\,
      R => '0'
    );
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_uart_rx is
  port (
    ...
    \m_axis_tdata_reg_reg[2]_0\ : out STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_uart_rx is
  ...
  signal rxd_reg_i_1_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of m_axis_tvalid_reg_i_1 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of rxd_reg_i_1 : label is "soft_lutpair4";
begin
...
\bit_cnt[3]_i_6\: unisim.vcomponents.LUT4
    generic map(
      ...
      I2 => prescale_reg_reg(10),
      I3 => prescale_reg_reg(8),
      O => \bit_cnt[3]_i_6_n_0\
    );
\bit_cnt[3]_i_7\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\bit_cnt[3]_i_8\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
\digit[3]_i_1\: unisim.vcomponents.LUT4
    generic map(
      ...
      I2 => \^q\(3),
      I3 => \digit[3]_i_2_n_0\,
      O => \m_axis_tdata_reg_reg[2]_0\
    );
\digit[3]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFDFFF"
    )
        port map (
...
\prescale_reg[0]_i_4\: unisim.vcomponents.LUT6
    generic map(
...
\prescale_reg[0]_i_7\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000FFFFFFFFFFFE"
    )
        port map (
...
\prescale_reg[12]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\prescale_reg[12]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\prescale_reg[12]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\prescale_reg[12]_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\prescale_reg[16]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\prescale_reg[16]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\prescale_reg[4]_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000FFFFFFFFFFFE"
    )
        port map (
...
\prescale_reg[8]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\prescale_reg[8]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\prescale_reg[8]_i_5\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000FFFFFFFFFFFE"
    )
        port map (
...
\prescale_reg_reg[0]_i_3\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => \bit_cnt[3]_i_3_n_0\,
      DI(2) => \bit_cnt[3]_i_3_n_0\,
      DI(1) => \bit_cnt[3]_i_3_n_0\,
      DI(0) => \bit_cnt[3]_i_3_n_0\,
      ...
      S(3) => \prescale_reg[0]_i_4_n_0\,
      S(2) => \prescale_reg[0]_i_5_n_0\,
      S(1) => \prescale_reg[0]_i_6_n_0\,
      S(0) => \prescale_reg[0]_i_7_n_0\
    );
...
\prescale_reg_reg[4]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \prescale_reg[4]_i_2_n_0\,
      S(2) => \prescale_reg[4]_i_3_n_0\,
      S(1) => \prescale_reg[4]_i_4_n_0\,
      S(0) => \prescale_reg[4]_i_5_n_0\
    );
...
rxd_reg_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
rxd_reg_reg: unisim.vcomponents.FDRE
    generic map(
      INIT => '1'
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_uart_tx is
  ...
  attribute SOFT_HLUTNM of \bit_cnt[3]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \data_reg[8]_i_3\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of txd_reg_i_3 : label is "soft_lutpair5";
begin
  rst <= \^rst\;
...
\prescale_reg[12]_i_2__0\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"3E"
    )
        port map (
...
\prescale_reg[12]_i_3__0\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"3E"
    )
        port map (
...
\prescale_reg[12]_i_4__0\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"3E"
    )
        port map (
...
\prescale_reg[12]_i_5__0\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"3E"
    )
        port map (
...
\prescale_reg[16]_i_3__0\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"3E"
    )
        port map (
...
\prescale_reg[16]_i_4__0\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"3E"
    )
        port map (
...
\prescale_reg[8]_i_3__0\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"3E"
    )
        port map (
...
\prescale_reg[8]_i_4__0\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"3E"
    )
        port map (
...
\prescale_reg[8]_i_5__0\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"3E"
    )
        port map (
...
\prescale_reg_reg[8]_i_1__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(2) => \prescale_reg[8]_i_3__0_n_0\,
      S(1) => \prescale_reg[8]_i_4__0_n_0\,
      S(0) => \prescale_reg[8]_i_5__0_n_0\
    );
\prescale_reg_reg[9]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
...
begin
display_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_uart_7seg_display
     port map (
      Q(3 downto 0) => rx_data(3 downto 0),
      clk => clk,
      \digit_reg[0]_0\ => uart_rx_inst_n_1,
      rst => rst,
      rst_n => rst_n,
      rx_seen => rx_seen,
...
uart_rx_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_uart_rx
     port map (
      ...
      clk => clk,
      \m_axis_tdata_reg_reg[2]_0\ => uart_rx_inst_n_1,
      rst => rst,
      rst_n => rst_n,
      rx_valid => rx_valid,
      rxd => rxd
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME clk, ASSOCIATED_RESET rst_n:rst, FREQ_HZ 50000000, PHASE 0.000, CLK_DOMAIN design_1_processing_system7_0_0_FCLK_CLK0, INSERT_VIP 0";
