...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_uart_7seg_display is
  port (
    ...
    \digit_reg[3]_0\ : in STD_LOGIC_VECTOR ( 3 downto 0 );
    clk : in STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_uart_7seg_display is
  ...
  signal \rx_seen_cnt_reg__0\ : STD_LOGIC_VECTOR ( 3 downto 1 );
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of rx_seen_INST_0 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \rx_seen_cnt[1]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \rx_seen_cnt[2]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \rx_seen_cnt[3]_i_2\ : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of \seg[4]_INST_0\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \seg[5]_INST_0\ : label is "soft_lutpair4";
begin
  Q(0) <= \^q\(0);
\digit_reg[0]\: unisim.vcomponents.FDCE
     port map (
      C => clk,
      CE => E(0),
      CLR => AR(0),
...
\digit_reg[1]\: unisim.vcomponents.FDCE
     port map (
      C => clk,
      CE => E(0),
      CLR => AR(0),
...
\digit_reg[2]\: unisim.vcomponents.FDCE
     port map (
      C => clk,
      CE => E(0),
      CLR => AR(0),
...
\digit_reg[3]\: unisim.vcomponents.FDCE
     port map (
      C => clk,
      CE => E(0),
      CLR => AR(0),
...
rx_seen_INST_0: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
      I0 => \rx_seen_cnt_reg__0\(3),
      I1 => \^q\(0),
      I2 => \rx_seen_cnt_reg__0\(1),
      I3 => \rx_seen_cnt_reg__0\(2),
      O => rx_seen
    );
\rx_seen_cnt[1]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"EB"
    )
        port map (
      I0 => E(0),
      I1 => \rx_seen_cnt_reg__0\(1),
      I2 => \^q\(0),
      O => \rx_seen_cnt[1]_i_1_n_0\
    );
\rx_seen_cnt[2]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FEAB"
    )
        port map (
...
\rx_seen_cnt[3]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
      I0 => E(0),
      I1 => \rx_seen_cnt_reg__0\(2),
      I2 => \rx_seen_cnt_reg__0\(1),
      I3 => \^q\(0),
      I4 => \rx_seen_cnt_reg__0\(3),
      O => \rx_seen_cnt[3]_i_1_n_0\
    );
\rx_seen_cnt[3]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFEAAAB"
    )
        port map (
...
\rx_seen_cnt_reg[0]\: unisim.vcomponents.FDCE
     port map (
      C => clk,
      CE => \rx_seen_cnt[3]_i_1_n_0\,
      CLR => AR(0),
      D => D(0),
      Q => \^q\(0)
    );
\rx_seen_cnt_reg[1]\: unisim.vcomponents.FDCE
     port map (
      C => clk,
      CE => \rx_seen_cnt[3]_i_1_n_0\,
      CLR => AR(0),
      D => \rx_seen_cnt[1]_i_1_n_0\,
      Q => \rx_seen_cnt_reg__0\(1)
    );
\rx_seen_cnt_reg[2]\: unisim.vcomponents.FDCE
     port map (
      C => clk,
      CE => \rx_seen_cnt[3]_i_1_n_0\,
      CLR => AR(0),
      D => \rx_seen_cnt[2]_i_1_n_0\,
      Q => \rx_seen_cnt_reg__0\(2)
    );
\rx_seen_cnt_reg[3]\: unisim.vcomponents.FDCE
     port map (
      C => clk,
      CE => \rx_seen_cnt[3]_i_1_n_0\,
      CLR => AR(0),
      D => p_0_in(3),
      Q => \rx_seen_cnt_reg__0\(3)
    );
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_uart_rx is
  port (
    ...
    \m_axis_tdata_reg_reg[5]_0\ : out STD_LOGIC_VECTOR ( 3 downto 0 );
    ...
    clk : in STD_LOGIC;
    rst_n : in STD_LOGIC;
    \rx_seen_cnt_reg[0]\ : in STD_LOGIC_VECTOR ( 0 to 0 )
  );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_uart_rx is
  ...
  attribute SOFT_HLUTNM of \bit_cnt[3]_i_4\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of busy_reg_i_1 : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of busy_reg_i_2 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \digit[0]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \digit[1]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \digit[2]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \digit[3]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of m_axis_tvalid_reg_i_1 : label is "soft_lutpair9";
begin
  E(0) <= \^e\(0);
...
\digit[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      ...
      I2 => \digit[3]_i_2_n_0\,
      I3 => \^q\(0),
      O => \m_axis_tdata_reg_reg[5]_0\(0)
    );
\digit[1]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFD"
    )
        port map (
      ...
      I2 => \digit[3]_i_2_n_0\,
      I3 => \^q\(1),
      O => \m_axis_tdata_reg_reg[5]_0\(1)
    );
\digit[2]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFD"
    )
        port map (
...
\rx_seen_cnt[0]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
      I0 => \^e\(0),
      I1 => \rx_seen_cnt_reg[0]\(0),
      O => D(0)
    );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_uart_tx is
  ...
  signal \p_0_in__0\ : STD_LOGIC_VECTOR ( 18 to 18 );
  ...
  attribute SOFT_HLUTNM of \bit_cnt[2]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \bit_cnt[3]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \data_reg[8]_i_3\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of txd_reg_i_3 : label is "soft_lutpair10";
begin
  AR(0) <= \^ar\(0);
...
txd_reg_i_5: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
      ...
      I3 => prescale_reg_reg(12),
      I4 => prescale_reg_reg(2),
      I5 => prescale_reg_reg(8),
      O => txd_reg_i_5_n_0
    );
txd_reg_i_6: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_uart_top is
  ...
  signal \rx_seen_cnt_reg__0\ : STD_LOGIC_VECTOR ( 0 to 0 );
...
display_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_uart_7seg_display
     port map (
      AR(0) => rst,
      D(0) => p_0_in(0),
      E(0) => \^m_axis_tvalid_reg_reg\,
      Q(0) => \rx_seen_cnt_reg__0\(0),
      clk => clk,
      \digit_reg[3]_0\(3) => uart_rx_inst_n_2,
      \digit_reg[3]_0\(2) => uart_rx_inst_n_3,
      \digit_reg[3]_0\(1) => uart_rx_inst_n_4,
      \digit_reg[3]_0\(0) => uart_rx_inst_n_5,
      rx_seen => rx_seen,
...
uart_rx_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_uart_rx
     port map (
      ...
      clk => clk,
      debug_busy => debug_busy,
      \m_axis_tdata_reg_reg[5]_0\(3) => uart_rx_inst_n_2,
      \m_axis_tdata_reg_reg[5]_0\(2) => uart_rx_inst_n_3,
      \m_axis_tdata_reg_reg[5]_0\(1) => uart_rx_inst_n_4,
      \m_axis_tdata_reg_reg[5]_0\(0) => uart_rx_inst_n_5,
      rst_n => rst_n,
      \rx_seen_cnt_reg[0]\(0) => \rx_seen_cnt_reg__0\(0),
      rxd => rxd
    );
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_uart_top
     port map (
      Q(7 downto 0) => debug_rx_data(7 downto 0),
      clk => clk,
      debug_busy => debug_busy,
