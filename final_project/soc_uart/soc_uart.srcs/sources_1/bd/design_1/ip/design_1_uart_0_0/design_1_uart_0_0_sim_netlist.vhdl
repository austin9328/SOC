...
--               D:/Documents/Vivado_data/soc_uart/soc_uart.srcs/sources_1/bd/design_1/ip/design_1_uart_0_0/design_1_uart_0_0_sim_netlist.vhdl
...
entity design_1_uart_0_0_uart_7seg_display is
  port (
  ...
  attribute ORIG_REF_NAME of design_1_uart_0_0_uart_7seg_display : entity is "uart_7seg_display";
end design_1_uart_0_0_uart_7seg_display;

architecture STRUCTURE of design_1_uart_0_0_uart_7seg_display is
...
rx_seen_reg: unisim.vcomponents.FDCE
     port map (
      C => clk,
      CE => E(0),
      CLR => rst,
...
architecture STRUCTURE of design_1_uart_0_0_uart_rx is
  ...
  attribute SOFT_HLUTNM of \bit_cnt[3]_i_4\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of busy_reg_i_1 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of busy_reg_i_2 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \digit[0]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \digit[1]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \digit[2]_i_2\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \digit[3]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of m_axis_tvalid_reg_i_1 : label is "soft_lutpair7";
begin
...
\digit[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFEEEA"
    )
        port map (
...
\digit[2]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"EFFF"
    )
        port map (
...
\digit[3]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFBF"
    )
        port map (
...
architecture STRUCTURE of design_1_uart_0_0_uart_tx is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \bit_cnt[0]_i_1\ : label is "soft_lutpair10";
  ...
  attribute SOFT_HLUTNM of \data_reg[8]_i_3\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of txd_reg_i_3 : label is "soft_lutpair8";
begin
  rst <= \^rst\;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_uart_0_0_uart_top is
  port (
    Q : out STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_uart_0_0_uart_top : entity is "uart_top";
end design_1_uart_0_0_uart_top;

architecture STRUCTURE of design_1_uart_0_0_uart_top is
  signal \^q\ : STD_LOGIC_VECTOR ( 7 downto 0 );
...
display_inst: entity work.design_1_uart_0_0_uart_7seg_display
     port map (
...
uart_rx_inst: entity work.design_1_uart_0_0_uart_rx
     port map (
      D(3) => uart_rx_inst_n_2,
      D(2) => uart_rx_inst_n_3,
      D(1) => uart_rx_inst_n_4,
...
uart_tx_inst: entity work.design_1_uart_0_0_uart_tx
     port map (
      E(0) => \^m_axis_tvalid_reg_reg\,
      Q(7 downto 0) => \^q\(7 downto 0),
      clk => clk,
...
entity design_1_uart_0_0 is
  ...
  attribute CHECK_LICENSE_TYPE of design_1_uart_0_0 : entity is "design_1_uart_0_0,uart_top,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of design_1_uart_0_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of design_1_uart_0_0 : entity is "uart_top,Vivado 2018.3";
...
begin
inst: entity work.design_1_uart_0_0_uart_top
     port map (
